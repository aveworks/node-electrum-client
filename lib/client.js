...
class Client{
    ...
    onEnd(){
        this.subscribe.emit('end')
    }

    onError(e){
        // Don't use error, cause it has a special functionality in nodejs
        this.subscribe.emit('err', e)
    }
